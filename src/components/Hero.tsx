  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 overflow-hidden bg-[#020202]">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-150px] left-[-150px] w-[500px] h-[500px] bg-indigo-600/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-[-150px] right-[-100px] w-[600px] h-[600px] bg-blue-500/10 rounded-full blur-[150px]" />
      </div>
          ...
          >
            ...
            <div className="flex justify-between items-start mb-8 relative z-20">
              <span className="bg-indigo-500/10 text-indigo-300 text-[10px] font-bold px-3 py-1 rounded-full border border-indigo-500/20 uppercase">
                {heroProduct.supplier}
              </span>
              <div className="text-right">
                <div className="text-[10px] opacity-40 uppercase tracking-tighter">Inventory Level</div>
                <div className="text-green-400 font-mono text-sm">{heroProduct.stock} UNITS</div>
              </div>
            </div>
            ...
            <div className="space-y-4 relative z-20">
              <h3 className="text-2xl font-bold tracking-tight text-white">{heroProduct.title}</h3>
